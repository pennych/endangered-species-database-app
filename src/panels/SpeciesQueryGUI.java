...
/**
 * Reveals all entries of the Endangered Species table in a uniform list that
 * the user can sort and make a selection from to view more details.
 * 
...
public class SpeciesQueryGUI extends JPanel {
	...
	public SpeciesQueryGUI() {
		...
		lblNewLabel.setBounds(10, 4, 267, 36);
		siPanel.add(lblNewLabel);

		siIDTextField = new JTextField();
		siIDTextField.setBounds(273, 4, 57, 36);
		...
		submitSiBtn.setBounds(378, 4, 89, 36);
		...
		idSortBtn.setBounds(91, 8, 116, 20);
