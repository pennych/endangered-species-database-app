...
public class SpeciesView extends JPanel {
	...
	/**
	 * @return button to update common
	 */
	...
	/**
	 * @return button for update pop
	 */
	/**
	 * @return butoon for update pop
	 */
	...
	/**
	 * @return button for update class
	 */
	...
	/**
	 * @return button for update threats
	 */
	...
	/**
	 * @return button for update cons effort
	 */
	...
	/**
	 * @return update colunm choice box
	 */
