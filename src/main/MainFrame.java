...
/**
 * Main JFrame to exchange panels and display species, region and conservation
 * effort information
 * 
...
public class MainFrame extends JFrame {
	...
	private void actionListeners() {
		...
		// --- SPECIES QUERY ACTION LISTENERS ---

		// NAVIGATE FROM SPECIES QUERY TO SPECIES VIEW
		...
		// QUERY SPECIES BASED ON CLASS USING COMBO BOX
		...
		regionOV.getSubmitBtn().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (regionOV.getRegionIDField().getText().isEmpty()) {
					...
					navBar.setTitleLabel(
							DBConnection.executeQueryReturnDataOnColumn(SqlRegion.getDistrict(rID), "District"));

					if (rID == 1) {
						region.getDescArea().setText(
					...
					region.getEmail()
							.setText(DBConnection.executeQueryReturnDataOnColumn(SqlRegion.getEmail(rID), "Email"));

					region.getPhone()
							.setText(DBConnection.executeQueryReturnDataOnColumn(SqlRegion.getPhone(rID), "Phone"));

					region.getHours()
							.setText(DBConnection.executeQueryReturnDataOnColumn(SqlRegion.getHours(rID), "Hours"));
	...
	private void navBarButtons() {
		...
		navBar.getRegionButton().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				regionOV.getRegionTextArea().setText(DBConnection.executeQueryReturnAllRegionData(SqlRegion.allData()));
